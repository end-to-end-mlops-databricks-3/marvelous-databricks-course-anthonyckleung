...
class HotelReservesModelWrapper(mlflow.pyfunc.PythonModel):
    ...
    def __init__(self, model: object) -> None:
        """Initialize the HotelReservesModelWrapper.
...
class CustomModel:
    """Custom model class for hotel reserve cancellation prediction.
    ...
    def log_model(self, dataset_type: Literal["PandasDataset", "SparkDataset"] = "SparkDataset") -> None:
        ...
        with mlflow.start_run(tags=self.tags) as run:
            ...
            mlflow.pyfunc.log_model(
                python_model=HotelReservesModelWrapper(self.pipeline),
                artifact_path="pyfunc-hotel-reserves-model",
    ...
    def register_model(self) -> None:
        ...
        registered_model = mlflow.register_model(
            model_uri=f"runs:/{self.run_id}/pyfunc-hotel-reserves-model",
            name=f"{self.catalog_name}.{self.schema_name}.hotel_reserves_model_custom",
            tags=self.tags,
        )
    ...
    def load_latest_model_and_predict(self, input_data: pd.DataFrame) -> np.ndarray:
        ...
        model_uri = f"models:/{self.catalog_name}.{self.schema_name}.hotel_reserves_model_custom@latest-model"
